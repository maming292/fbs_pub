...
export class RuningComponent implements OnInit {
	...
	leftData: electricModule = {
		all: '0',
		companyNumber: '0',
		month: '0',
		day: '0'
	};
	topData: electricModule = {
		all: '0',
		companyNumber: '0',
		month: '0',
		day: '0'
	...
	tables() {
		...
		this.route.navigate(['/home/tablestatc'], {
			queryParams: {
				id: 112
			}
		})
